...
//  VistaBridge
//
//  Created by 齐晴 on 17/1/2.
//  Copyright © 2017年 GaryQi. All rights reserved.
//

import UIKit

class PropCell: UITableViewCell {

    @IBOutlet weak var label_propName: UILabel!
    ...
    func prepareScrollViewForImages(_ propID : Int){
        ...
        for prop in props {
            ...
            if images != [] {
                ...
                for imageName in images {
                    ...
                    let tapGesture = UITapGestureRecognizer(target: self, action: #selector(PropCell.imageTaped(_:)))
